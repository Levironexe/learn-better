...
- TypeScript 5.9 / Node.js 20+ + Next.js 16.1.7 (App Router), React 19.2.3, Tailwind CSS v4, `lucide-react` ^0.577.0, `react-markdown` + `remark-gfm` (existing preview renderer) (008-content-styling-toolbar)
- PostgreSQL via Supabase — existing `content_markdown` field on `lesson_sections` table. No schema changes. (008-content-styling-toolbar)
...
## Recent Changes
- 008-content-styling-toolbar: Added TypeScript 5.9 / Node.js 20+ + Next.js 16.1.7 (App Router), React 19.2.3, Tailwind CSS v4, `lucide-react` ^0.577.0, `react-markdown` + `remark-gfm` (existing preview renderer)
